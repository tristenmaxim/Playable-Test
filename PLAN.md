...
### 1.1 Базовая HTML-структура
- [ ] Создать базовый HTML-файл с правильной структурой
- [ ] Добавить мета-теги для мобильных устройств
- [ ] Настроить стили (CSS) для полноэкранного отображения

### 1.2 Инициализация PixiJS
- [ ] Подключить PixiJS (CDN или встроенная версия)
- [ ] Создать Application с правильными параметрами
- [ ] Настроить canvas для адаптивности

### 1.3 Фон
- [ ] Конвертировать `asset_0015_background_1.png` в base64 data URI
- [ ] Встроить фон в HTML как data URI
- [ ] Создать спрайт фона и добавить на сцену
- [ ] Реализовать параллакс-скролл фона
- [ ] Добавить дублирование фона для бесшовного скролла
